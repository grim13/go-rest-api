...
func registerForEvent(context *gin.Context) {
	...
	context.JSON(http.StatusCreated, gin.H{"message": "Registerred."})
}

func cencelRegistraion(context *gin.Context) {
	userId := context.GetInt64("userId")
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not cancel registraion."})
		return
	}
